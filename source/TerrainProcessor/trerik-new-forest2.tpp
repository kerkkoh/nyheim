    ...
    <Tasks>
        <Task>
            ...
            <ObjectPrototypes>
                <ObjectPrototype>
                    ...
                    <Parameter Name="MINDIST" Value="0"/>
                </ObjectPrototype>
                <ObjectPrototype>
        ...
        <Task>
            ...
            <Parameters>
                ...
                <Parameter Name="Hectare density" Type="0" Value="650"/>
            </Parameters>
            <ObjectPrototypes>
                <ObjectPrototype>
                ...
                <ObjectPrototype>
                    <Parameter Name="OBJECT" Value="t_malusDomestica_3s"/>
        ...
        <Task>
            <Shapefile>P:\trerik4\source\shapefiles\leafy_forest_low_dens.shp</Shapefile>
            <TaskName>Area: High-density Cluster</TaskName>
            <DEMInputFilename></DEMInputFilename>
            <DEMOutputFilename></DEMOutputFilename>
            <Enabled>1</Enabled>
            <Notes>Low density Bushes</Notes>
            <Parameters>
                <Parameter Name="Random seed" Type="0" Value="90"/>
                <Parameter Name="Hectare density" Type="0" Value="120"/>
                <Parameter Name="Fraction" Type="0" Value="1"/>
        ...
        <Task>
            ...
            <DEMOutputFilename></DEMOutputFilename>
            <Enabled>1</Enabled>
            <Notes>Low density Stones</Notes>
            <Parameters>
                <Parameter Name="Random seed" Type="0" Value="100"/>
                <Parameter Name="Hectare density" Type="0" Value="5"/>
            </Parameters>
        ...
        <Task>
            ...
            <DEMOutputFilename></DEMOutputFilename>
            <Enabled>1</Enabled>
            <Notes>Low density forest mask</Notes>
            <Parameters>
        ...
        <Task>
            ...
            <DEMOutputFilename></DEMOutputFilename>
            <Enabled>1</Enabled>
            <Notes>Forest mask polygons</Notes>
            <Parameters>
                <Parameter Name="Remove objects" Type="0" Value="Inside"/>
            </Parameters>
            <ObjectPrototypes/>
        ...
        <Task>
            ...
            <DEMOutputFilename></DEMOutputFilename>
            <Enabled>1</Enabled>
            <Notes>Forest mask polylines</Notes>
            <Parameters>
